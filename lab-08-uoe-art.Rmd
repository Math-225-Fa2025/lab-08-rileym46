...
`The url is a lot shorter than the one from earlier and include https://collections.ed.ac.uk/ before the ./record.`
...
```{r second-ten, eval = TRUE}
second_ten <- "https://collections.ed.ac.uk/art/search/*:*/Collection:%22edinburgh+college+of+art%7C%7C%7CEdinburgh+College+of+Art%22?offset=10"

page <- read_html(second_ten)

title <- page %>%
  html_nodes(".iteminfo") %>%
  html_node(".record-title a") %>%
  html_text()
title
